package com.kitek.greatojcodesandbox.utils;
...
public class ProcessUtils {
     ...
     * @return
     */
    public static ExecuteMessage runProcessAndGetMessage(Process runProcess, String processState,Long memoryUsageBefore) {
        ...
        try {
            ...
            stopWatch.stop();
            // 将程序执行时间设置进来
            executeMessage.setMemory(memoryUsageAfter / 1024);
