...
import com.kitek.greatojcodesandbox.CodeSandBox;
...
import com.kitek.greatojcodesandbox.model.ExecuteMessage;
import com.kitek.greatojcodesandbox.model.JudgeInfo;
import com.kitek.greatojcodesandbox.utils.ProcessUtils;
...
public abstract class JavaCodeSandboxTemplate implements CodeSandBox {
    ...
    public ExecuteCodeResponse executeCode(ExecuteCodeRequest executeCodeRequest) {
        ...
        // 2、编译代码，得到class文件
        ExecuteCodeResponse compileFileExecuteMessage = compileFile(userCodeFile);
     ...
     * @return
     */
    public ExecuteCodeResponse compileFile(File userCodeFile) {
        ...
        try {
            ...
            ExecuteMessage executeMessage = ProcessUtils.runProcessAndGetMessage(compileProcess, "编译",memoryUsageBefore);
    ...
    public List<ExecuteMessage> runCode(File userCodeFile, List<String> inputList) {
        ...
        for (String inputArgs : inputList) {
            ...
            try {
                ...
                ExecuteMessage executeMessage = ProcessUtils.runProcessAndGetMessage(runProcess, "运行",memoryUsageBefore);
